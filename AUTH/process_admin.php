<?php
    ...
    if($count == 1){
            ...
            if($num_attempts >= 3 && $hours_since_last_login < 3){
                ...
                if($attempts_left == 0){
                    echo("<script>
                        ...
                        alert('Check your admin login details. You have ".$attempts_left." attempt(s) left. Please contact an ICT admin before trying again.');
                        </script>");
                } else{
                    echo("<script>
                        window.location.href='../AUTH/';
                        alert('Check your admin login details. You have ".$attempts_left." attempt(s) left.');
                        </script>");
                }
            }
        }
        ...
        echo("<script>
            window.location.href='../AUTH/';
            alert('Check your admin login details.');
            </script>");
    }
?>