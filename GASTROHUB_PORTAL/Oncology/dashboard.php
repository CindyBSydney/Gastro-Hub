							...
							if ($result->num_rows > 0) {
								while ($row = $result->fetch_assoc()) {
									...
									if ($counter === 1 && $is_available_num == 1) {
										echo "<td style='display:flex;align-items:center;justify-content:center;'><span disabled style='text-align:center;border:none;border-radius:10px;height:30px;width:200px;background-color: green;color:white;'>Oncology Assessment</span></td>";
										?>
