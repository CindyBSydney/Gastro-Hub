<?php
    ...
    $radiologist_general_comment = $_POST['radiologist_general_comment'];
    $cancer_detection = $_POST['cancer_detection'];

    // Update the patient's commentary record
    $query = "UPDATE tbl_patient_commentary SET radiologist_general_comment='$radiologist_general_comment', cancer_detection_approval='$cancer_detection' WHERE patient_commentary_id='$patient_commentary_id'";
