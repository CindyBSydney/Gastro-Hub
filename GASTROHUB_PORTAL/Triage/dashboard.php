							...
							if ($result->num_rows > 0) {
								while ($row = $result->fetch_assoc()) {
									...
									if ($counter === 1 && $is_available_num == 1) {
										echo "<td style='display:flex;align-items:center;justify-content:center;'><span disabled style='text-align:center;border:none;border-radius:10px;height:30px;width:200px;background-color: green;color:white;'>Triage Assessment</span></td>";
									} else {
									...
									?>
									<td style="text-align:center;"><button onclick="window.location.href='add_to_queue.php?patient_id=<?php echo($patient_id); ?>'">Take Readings</button></td>
									<?php
