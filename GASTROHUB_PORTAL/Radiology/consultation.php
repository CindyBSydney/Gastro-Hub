                ...
                <div class="table-data">
                    <div class="todo">
                        ...
                        <?php
                            ...
                            $result = getData($sql);
                            $radiologist_queue_number = $result["radiologist_queue_number"];
                        ...
                        <ul class="todo-list">
                            ...
                            <li class="completed">
                                <p>
                                    ...
                                    <input style="text-align:center;border:none;width:70px;height:40px;border-radius:10px;padding:10px;" type="text" disabled value="<?php echo($radiologist_queue_number); ?>" name="radiologist_queue_number" class="form-control"/>
                                </p>
                            </li>
                            ...
                            <li class="completed">
                                <p>
                                    ...
                                    <textarea style="border:none;width:500px;border-radius:10px;padding:10px;" type="text" rows="5" name="radiologist_general_comment" maxlength="200" class="form-control" required></textarea>
                                </p>
                            </li>
                            <li class="not-completed">
                                <p>
                                    <?php echo "Radiology Cancer Detection Approval:&emsp;"; ?>
